...
# PR8: schema/battery/demo blocks were moved out to keep this module under the
# architecture-gate file-size limit. Re-export the public names so the legacy
# module API stays unchanged.
from data_layer_schema import (  # noqa: E402
    INDEX_COLUMNS,
    _ALIAS_MAP,
    _LEGACY_DEFAULT_DESIGN_BUDGET,
    _alias_keys,
    _default_design_budget,
    _default_state,
    _write_json_atomic,
)
