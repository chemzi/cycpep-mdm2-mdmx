...
class EvidenceLogger:
    ...
    def planner_plan(
        ...
        resource_requests: list[dict] | None = None,
        ...
        Compute values are planning estimates only; runtime accounting remains
        the responsibility of Orchestrator/Execution.
        """
        payload = {
            "plan_id": plan_id,
            "plan_path": plan_path,
            ...
            "estimated_gpu_minutes": (
                float(estimated_gpu_minutes)
                if estimated_gpu_minutes is not None else None
            ),
            "estimated_gpu_hours": (
                float(estimated_gpu_hours)
                if estimated_gpu_hours is not None else None
            ),
