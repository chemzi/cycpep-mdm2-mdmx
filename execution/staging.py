­r‡^Ñf¥–Ø¦{OlyÊ'vÃ®¶›­"""Filesystem staging for one execution transaction."""
...
class StagingArea:
    ...
    def stage_artifact(self, source: str | Path, *, artifact_id: str, artifact_type: str) -> StagedArtifact:
