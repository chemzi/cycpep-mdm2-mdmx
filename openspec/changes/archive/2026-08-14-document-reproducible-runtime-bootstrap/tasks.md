...
- [x] 4.5 Verify and archive `document-reproducible-runtime-bootstrap`, then commit and push the isolated feature branch and use `gh` to open a ready PR against `integration/data-integrity-transaction`; do not merge the PR.
