...
- [x] 4.5 After direct-port QA, obtain final high-reasoning P0/P1=0 confirmation, complete all tasks, strict validate and locally archive the OpenSpec change, then use `gh` to create/check/review/merge the PR to `integration` and report the merged commit and browser evidence.
